...
// Inline shape-glyph for a function kind. Solid style: filled "row" bars,
// stroked arrows/buffer box, a filled "value" dot, drawn in the kind's brand
// colour. Every glyph reads left-to-right as a cardinality transform (what goes
// in vs. what comes out), so the five read as one family. Used standalone in the
// overview table and inside <KindBanner> at the top of each function page.
const props = defineProps({
  kind: { type: String, required: true },
  size: { type: [Number, String], default: 40 },
})

// Shared primitives so the shapes stay consistent. A "row" is a rounded bar; an
// arrow is a line + chevron; a "value" is a filled dot.
